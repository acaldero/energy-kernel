...
{
    consumption = (staticPower + constant * pow(utilization *100,3)) * timeInterval;
    return &consumption;
}
...
{
    consumption = (staticPower + constant * utilization *100) * timeInterval;
    return &consumption;
}
...
{
    consumption = (staticPower + constant * pow(utilization *100,2)) * timeInterval;
    return &consumption;
}
...
{
    consumption = (staticPower + constant * sqrt(utilization *100)) * timeInterval;
    return &consumption;
}
...
int main ( int argc, char *argv[] )
{
    ...
    // header
    printf("Algorithm; Time-elapsed (us)\n"); 
